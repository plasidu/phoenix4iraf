import sys
# Hardcoded, sry
sys.path.append('/usr/lib/python3/dist-packages/astrolibpy/astrolib')
from numpy import *
...
# For use with bash script reading output file from iraf
...
#2005-June-20      Kochukhov Included precession of RA2000 and DEC2000 to current epoch
   ...
   if debug:   
      ...
      print '' '''
   line = '%s %s' % (hjd, corrmin)
   return line


# Geolocation is not needed for heliocentric correction
print(helcorr( 0, 0, 0, ra_star, dec_star, jd, debug=False))
